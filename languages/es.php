...
return array(
	...
	'river:profileiconupdate:default' => '%s actualizó su avatar',
...
',
	...
	'wall:tag:river' => '%s etiquetó a %s en un %s',
	...
	'mechanics:delete:group:default:desc' => 'Cada vez que borres un grupo, recibirás %d punto, hasta un máximo de %d punto.',
	...
	'mechanics:create:relationship:invited:desc' => 'Cada vez que invites a alguien a unirse a un grupo, recibirás %d punto, hasta un máximo de %d puntos.',
	'mechanics:publish:object:hjwall:photo' => 'Publicar una foto',
	'mechanics:publish:object:hjwall:photo:desc' => 'Cada vez que publiques una foto, recibirás %d punto, hasta un máximo de %d puntos.',
	'mechanics:publish:object:hjwall:share' => 'Compartir una publicación',
	'mechanics:publish:object:hjwall:share:desc' => 'Cada vez que compartas una publicación, recibirás %d punto, hasta un máximo de %d puntos.',
	'mechanics:publish:object:hjwall:location' => 'Añadir una localización en alguna de tus publicaciones',
	'mechanics:publish:object:hjwall:location:desc' => 'Cada vez que añadas una localización a alguna de tus publicaciones, recibirás %d punto, hasta un máximo de %d puntos.',
	'mechanics:publish:object:hjwall:url' => 'Añadir un enlace en alguna de tus publicaciones',
	'mechanics:publish:object:hjwall:location:url' => 'Cada vez que añadas un enlace a alguna de tus publicaciones, recibirás %d punto, hasta un máximo de %d puntos.',
	'mechanics:create:group:secret' => 'Crear un grupo secreto',
	'mechanics:create:group:secret:desc' => 'Cada vez que crees un grupo secreto, recibirás %d punto, hasta un máximo de %d punto.',
	'mechanics:create:group:private' => 'Crear un grupo privado',
	'mechanics:create:group:private:desc' => 'Cada vez que crees un grupo privado, recibirás %d punto, hasta un máximo de %d punto.',
	'mechanics:create:group:public' => 'Crear un grupo público',
	'mechanics:create:group:public:desc' => 'Cada vez que crees un grupo público, recibirás %d punto, hasta un máximo de %d punto.',
	'mechanics:create:friendscollection' => 'Crear una colección de amigos',
	'mechanics:create:friendscollection:desc' => 'Cada vez que crees una colección de amigos, recibirás %d punto, hasta un máximo de %d punto.',
	'mechanics:create:annotation:starrating' => 'Valorar a los usuarios',
	'mechanics:create:annotation:starrating:desc' => 'Cada vez que valores a otros usuarios, recibirás %d punto, hasta un máximo de %d puntos.',
	'mechanics:publish:object:hjwall:friend_tags' => 'Etiquetar amigos en una publicación',
	'mechanics:publish:object:hjwall:friend_tags:desc' => 'Cada vez que etiquetes a otros usuarios en tu publicación, recibirás %d punto, hasta un máximo de %d puntos.',
	...
	'interactions:settings:max_comment_depth:help' => 'Profundidad máxima de las replicas a los comentarios. 1 = sin replicas, 5 = replicas permitidas hasta el cuarto descendiente',



	'interactions:settings:comment_form_position' => 'Posicion del formulario de comentarios',



	'interactions:settings:comment_form_position:help' => '¿Donde debería posicionarse el formulario en relación a la lista de comentarios?',
	...
	'interactions:settings:comments_order' => 'Ordenación de comentarios',



	'interactions:settings:comments_order:help' => 'En que orden deben ser presentados los comentarios: Cronológico (Primero los más antiguos, los nuevos al final) o inversamente',



	'interactions:settings:comments_order:chronological' => 'Cronologico',



	'interactions:settings:comments_order:reverse_chronological' => 'Cronologico inverso',



	'interactions:settings:comments_load_style' => 'Visión y carga de comentarios',



	'interactions:settings:comments_load_style:load_older' => 'Presentar comentarios más nuevos con un enlace para cargar los comentarios más antiguos',



	'interactions:settings:comments_load_style:load_newer' => 'Presentar comentarios más antiguos con un enlace para cargar los comentarios más nuevos',



	'interactions:settings:comments_limit' => 'Número de comentarios a presentar inicialmente',



	'interactions:settings:comments_load_limit' => 'Número de comentarios a cargar en cada iteración',
...
',
	...
	'friend:notifications:summary' => " %s te ha hecho su amigo",
	...
	'notifier:message:dismissed_all' => "Todas las notificaciones marcadas como leídas",
	...
	'user:friends:last_action' => "Visto %s", 
	...
	'feed:subject:other' => "otro",

	'feed:subject:others' => "otros",
	...
	'user:settings:avatar' => "Imagen de perfil",
	...
	'user:settings:notifications' => "Notificaciones",



	'user:settings:tools' => "Herramientas",
	...
	'user:friends:friend_list_visibility' => "Visibilidad de la lista de amigos",



	'user:friends:friend_list_visibility:help' => "Aquí puedes restringir la visibilidad de tu lista de amigos a un subconjunto de usuarios",



	'user:friends:visibility:private' => "Solo yo",



	'user:friends:visibility:friends' => "Amigos",



	'user:friends:visibility:logged_in' => "Usuarios autenticados",
	...
	'wall:usersettings:river_access_id:help' => "¿Quién puede ver que fuiste etiquetado en el muro de otro usuario, si el mensaje original no se compartió con ellos?",
	...
	'profile_manager:register:hints:password' => "Tu contraseña para ingresar como usuario. Debe tener al menos 6 caracteres."
